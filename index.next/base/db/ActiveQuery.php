...
class ActiveQuery extends \yii\db\ActiveQuery
{
    ...
    protected function getSimpleFilterCondition($type, $field, $comparison, $value, $expression = '', $modelClass = '', $tableAlias = '')
    {
        /**
         * @var $modelClass ActiveRecord
         */
        ...
        $tableName = ($tableAlias ? $tableAlias : $this->tableName($modelClass));
        ...
        if (!$type || $fieldConf['type'] == 'fromextended') {
        ...
        if ($type == 'string' || $type == 'tinystring') {
            ...
            $relatedTableName = $this->pointers[$field]['table'];
            $res = ['like', ($relatedTableName.".".$relatedFieldName), $value];
        } elseif ($type == 'fromextended') {
            /**
             * @var $extendedModelClass ActiveRecord;
             */
            $extendedModelClass = $modelClass::getExtendedModelName();

            return $this->getSimpleFilterCondition('', $field, $comparison, $value, $expression, $extendedModelClass, '__extended_model_table');
        }
        return $res;
    }
...
//        $defaultWhere = $modelClass::defaultWhere(is_array($this->from) ? array_keys($this->from)[0] : $this->from);
...
//        }
        ...
        if(
            ...
            $this->from([$relatedTableName => "__link_model_table"]);
