    ...
    if (mode == 'edit') {
      ...
      for (var i = 0; i < model.fields.length; i++) {
        switch (model.fields[i].type) {
          case "string", "text", "url", "email", "html", "key_val", "select" : this._model.record[model.fields[i].name] = ""; break;
          case "int", "real", "bool", "pointer" : this._model.record[model.fields[i].name] = 0; break;
        }
      }
      this._recordId = 0;
    }
