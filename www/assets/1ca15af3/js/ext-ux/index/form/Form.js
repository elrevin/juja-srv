Ext.define('Ext.ux.index.form.Form', {
    ...
    createFields: function () {
        ...
        if (me.model && (modelFieldsCount = me.model.fields.getCount())) {
            ...
            for (i =0; i < modelFieldsCount; i++) {
                ...
                me._filterAnalytic(field, Ext.getCmp(me.id + '_field_' + field.name));
            }
        }
    },
        ...
        if (comboType == 'tree') {
            me.parentRecordCombo = Ext.create('Ext.ux.form.field.TreeCombo', {
                store: Ext.create('Ext.data.TreeStore', {
                    ...
                    proxy: {
                        type: 'ajax',
                        url: $url(parentModel.getDataAction[0], parentModel.getDataAction[1], parentModel.getDataAction[2], {modelName: parentModelName, identifyOnly: 1, all: 1, pf: (me.model.parentModelName ? 1 : 0)}),
    ...
    renew: function () {
        ...
        me.model = Ext.create(me.modelClassName, {});
        Ext.ux.index.form.Form.superclass.superclass.loadRecord.apply(me, [me.model]);
    },
